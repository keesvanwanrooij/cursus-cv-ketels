  ...
  quiz: [
    {
      ...
      opties: [`De ketel schakelt bij elke warmtevraag eerst automatisch over naar tapwaterbedrijf, ook als er geen kraan open staat`, `De ketel vraagt de thermostaat om de gewenste temperatuur`, `De ketel warmt op tot de vaste, op de ketel zelf ingestelde temperatuur, ongeacht de werkelijke warmtebehoefte`, `De ketel moduleert automatisch naar de laagste stand die nog toereikend is`],
      goed: 2,
    ...
    },
    {
      ...
      opties: [`1,6 graden`, `160 graden`, `16,0 graden`, `22,0 graden`],
      goed: 3,
    ...
    },
    {
      ...
      opties: [`De ketel moduleert soepel door naar 3 kW`, `De ketel gaat in storing`, `De ketel pendelt: hij slaat aan en uit omdat hij niet onder zijn minimale belasting kan moduleren`, `De ketel schakelt naar tapwaterbedrijf`],
      goed: 2,
    ...
    },
    {
      ...
      opties: [`Data-ID 25`, `Data-ID 27`, `Data-ID 17`, `Data-ID 18`],
      goed: 1,
    ...
    },
    {
      ...
      opties: [`Hij schakelt de ketel 's nachts helemaal uit`, `Hij verkort de opwarmtijd van de woning`, `Hij verlaagt automatisch de warmwatertemperatuur`, `De ketel brandt minder hard zodra er minder warmte nodig is, in plaats van steeds vol vermogen te leveren tot de temperatuur is bereikt`],
      goed: 3,
  ...
  quiz: [
    {
      ...
      opties: [`De ketel negeert de kamerthermostaat volledig zodra de buitenvoeler is aangesloten`, `De ketel schakelt alleen nog aan en uit, nooit meer modulerend`, `De ketel levert vanaf dat moment alleen nog tapwater en stopt met cv-verwarming, ongeacht de warmtevraag`, `De ketel is langer en op een lager niveau in bedrijf, in plaats van kort en op hoog vermogen`],
      goed: 3,
    ...
    },
    {
      ...
      opties: [`90 graden, het toestel schakelt naar de maximale bedrijfstemperatuur`, `25 graden, want -10 ligt onder de laagste ingestelde buitentemperatuur`, `80 graden, want -10 graden ligt onder de -7 graden ondergrens van de lijn`, `Ergens tussen 25 en 80 graden, recht evenredig met de buitentemperatuur`],
      goed: 2,
    ...
    },
    {
      ...
      opties: [`De stooklijn verandert niet, alleen het setpoint van de thermostaat wijzigt`, `De hele stooklijn verschuift evenwijdig, waardoor bij dezelfde buitentemperatuur een iets hogere aanvoertemperatuur wordt berekend`, `De ketel schakelt over naar een vaste temperatuur van 21 graden`, `De stooklijnwaarde zelf (0,4) wordt door het toestel automatisch verhoogd naar 0,5, onafhankelijk van de ingestelde kamertemperatuur`],
      goed: 1,
    ...
    },
    {
      ...
      opties: [`Nachtverlaging heeft geen invloed op de retourtemperatuur`, `Een lagere ingestelde temperatuur geeft via de stooklijn een lagere retourtemperatuur, waardoor de ketel meer kan condenseren`, `Nachtverlaging verhoogt de retourtemperatuur, wat het rendement verbetert`, `Nachtverlaging werkt uitsluitend bij een aan/uit-thermostaat en heeft geen enkel effect bij een modulerende regeling`],
      goed: 1,
    ...
    },
    {
      ...
      opties: [`De buitenvoeler verwijderen`, `De ketel op de maximale aanvoertemperatuur laten regelen, altijd`, `Overschakelen naar een aan/uit-thermostaat`, `Direct de stooklijn veel steiler instellen`, `De nachtverlaging kleiner maken (bijvoorbeeld 2 in plaats van 5 graden) in plaats van meteen de stooklijn aan te passen, vanwege de lagere aanvoertemperatuur en grotere massa van vloerverwarming`],
      goed: 4,
...
`,
  ...
  quiz: [
    ...
    },
    {
      ...
      opties: [`Het verdelen van tapwater over meerdere badkamers`, `Het instellen van verschillende CW-klassen per verdieping`, `Het apart van elkaar kunnen verwarmen van zones of kamers, in plaats van het hele huis op een enkele kamertemperatuur te sturen`, `Het automatisch wisselen tussen aardgas en een ander gas`],
      goed: 2,
    ...
    },
    {
      ...
      opties: [`De pomp kan het water niet meer voldoende rondpompen, waardoor de ketel de opgewekte warmte niet kwijt kan`, `Het tapwater wordt kouder`, `De gasvoordruk daalt tot onder de minimumwaarde`, `De ketel krijgt automatisch een hogere CW-klasse`],
      goed: 0,
    ...
    },
    {
      ...
      opties: [`De stooklijn permanent op de maximale waarde zetten, ongeacht de buitentemperatuur of het type afgifte`, `Een tweede ketel plaatsen`, `Zorg voor een minimale watercirculatie en plaats eventueel een bypassventiel`, `De thermostatische kranen verwijderen`],
      goed: 2,
    ...
    },
    {
      ...
      opties: [`Of er een bypass aanwezig is en die goed functioneert, voordat je de pomp of het toerental aanpast`, `De CW-klasse van de ketel`, `De gasvoordruk van het toestel`, `Meteen de pomp vervangen door een grotere`],
      goed: 0,
...
`,
  ...
  quiz: [
    ...
    },
    {
      ...
      opties: [`55 graden`, `60 graden`, `45 graden`, `50 graden`],
      goed: 0,
    ...
    },
    {
      ...
      opties: [`Omdat een woning altijd een eigen boiler heeft`, `Omdat de temperatuur in een woning wettelijk vrij te kiezen is`, `Omdat er in een woning geen legionellarisico bestaat`, `Omdat de zwaardere verplichting tot risicoanalyse en beheersplan is voorbehouden aan specifiek aangewezen locaties zoals ziekenhuizen, hotels en zwembaden`],
      goed: 3,
    ...
    },
    {
      ...
      opties: [`Prima idee, lager is altijd veiliger`, `Niet doen: bij 45 graden zit de boiler midden in de groeizone van legionella; beter is de boiler op minstens 60 graden te laten en een thermostatische mengkraan met temperatuurbegrenzing te plaatsen`, `Verlagen naar 45 graden mag, zolang er wekelijks thermisch wordt gedesinfecteerd op 45 graden`, `Verlagen naar 45 graden mag alleen bij een woning met circulatie`],
      goed: 1,
    ...
    },
    {
      ...
      opties: [`Alleen bij een storing`, `Nooit, eenmaal instellen is genoeg`, `Wekelijks`, `Jaarlijks`],
      goed: 3,
